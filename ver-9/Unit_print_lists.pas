  ...
  begin
   ...
   begin
    ...
    begin
     ...
     (wwDBLookupCombo1.LookupValue = '21')
   ...
   begin
    ...
    begin
     if (wwDBLookupCombo1.LookupValue = '10') or
        (wwDBLookupCombo1.LookupValue = '19') or
        (wwDBLookupCombo1.LookupValue = '20') or
        (wwDBLookupCombo1.LookupValue = '22')
      then
     begin
       ...
       if (wwDBLookupCombo1.LookupValue = '10') then
         ...
         OD_data.SetVariable('rep_id_', 22);//реестр по доп.счетам
       ...
       begin
         Writeln(f, OD_data.FieldByName('lsk').AsString+'|'+
          ...
          leftstr(OD_data.FieldByName('adr').AsString,30)+'|'+
