object Form_add_prop: TForm_add_prop
  Left = 596
  Top = 144
  Width = 496
  Height = 462
  Caption = #1053#1086#1074#1099#1081' '#1088#1077#1082#1074#1080#1079#1080#1090
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Button1: TButton
      ...
      Height = 25
      Cancel = True
      Caption = #1042#1099#1073#1088#1072#1090#1100' '#1080#1079' '#1089#1087#1080#1089#1082#1072
      TabOrder = 1
  ...
  object OD_list: TOracleDataSet
    SQL.Strings = (
      'select t.id, t.name, t.rowid from scott.u_list t'
      'where exists'
      '(select * from scott.u_listtp tp where t.fk_listtp=tp.id'
      ' and tp.name like '#39'%'#39'||:tp_||'#39'%'#39')'
      ' and Upper(t.name) like Upper('#39'%'#39'||:flt_||'#39'%'#39')'
      'order by t.name')
    Optimize = False
    Variables.Data = {
      0300000002000000050000003A464C545F050000000000000000000000040000
      003A54505F050000000000000000000000}
