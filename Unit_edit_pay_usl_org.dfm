object Form_edit_pay_usl_org: TForm_edit_pay_usl_org
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Align = alClient
    DataSource = DS_kwtp_day
    Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap, dgShowFooter, dgProportionalColResize]
    TabOrder = 1
