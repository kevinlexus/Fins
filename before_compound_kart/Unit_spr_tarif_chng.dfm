object Form_spr_tarif_chng: TForm_spr_tarif_chng
  Left = 878
  Top = 141
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = #1057#1084#1077#1085#1072' '#1090#1072#1088#1080#1092#1072
  ClientHeight = 108
  ClientWidth = 316
  Color = clBtnFace
  ...
  object wwDBLookupCombo1: TwwDBLookupCombo
    ...
    Selected.Strings = (
      ...
      'CENA'#9'7'#9#1058#1077#1082'.'#1094#1077#1085#1072#9'F'#9)
    LookupTable = Form_spr_tarif.OD_spr_tarif2
    LookupField = 'ID'
    TabOrder = 2
    AutoDropDown = False
    ShowButton = True
  ...
  object wwDBEdit1: TwwDBEdit
    ...
    Height = 21
    DataField = 'NAME'
    DataSource = Form_spr_tarif.DS_spr_tarif
    ReadOnly = True
    TabOrder = 1
