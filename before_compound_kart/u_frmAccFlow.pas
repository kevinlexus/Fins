...
uses
  ...
  ComObj, cxCustomData, cxFilter, cxData, cxDataStorage, cxEdit, cxNavigator,
  cxDBData, cxGridLevel, cxClasses, cxGridCustomView,
  cxGridCustomTableView, cxGridTableView, cxGridDBTableView, cxGrid,
  dxBarBuiltInMenu, cxContainer, cxTextEdit, cxMaskEdit, cxDropDownEdit,
  cxLookupEdit, cxGridExportLink, cxDBLookupEdit, cxDBLookupComboBox, cxPC, StdCtrls, Menus,
  ExtCtrls;
