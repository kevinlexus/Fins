object Form_print_stat_usl: TForm_print_stat_usl
  Left = 600
  Top = 438
  ...
  object GroupBox3: TGroupBox
    ...
    object BitBtn1: TBitBtn
      ...
      Glyph.Data = {
        ...
        
  ...
  object OracleDataSet1: TOracleDataSet
    SQL.Strings = (
        ...
        'mg,1,4)||'#39' '#1075'.'#39' as mg1 '
      'from scott.v_period_reports t where t.id=:id_ and mg is not null'
      'order by mg desc'
      '')
    Optimize = False
    Variables.Data = {0300000001000000040000003A49445F030000000000000000000000}
  ...
  object OD_reu_trest: TOracleDataSet
    SQL.Strings = (
      'select t.reu as key, t.reu from scott.s_reu_trest t')
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
  ...
  object OD_data: TOracleDataSet
    SQL.Strings = (
      ...
      'begin'
        ...
        '    :var_, :det_, :org_, :oper_, :cd_,  :spk_id_, :p_house, :p_o' +
        'ut_tp, :prep_refcursor);'
      'end;')
    Optimize = False
    Variables.Data = {
      
      3A505F4F55545F5450030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      524F43010000000000080000004E414D455F524555010000000000}
    Session = DataModule1.OracleSession1
    Left = 8
    Top = 40
  end
  ...
  object PivotCube18: TPivotCube
    FactTableDataSet = OD_data
    Dimensions = <
      item
        Enabled = True
        AliasName = 'PREDPR'
      ...
      item
        ...
        NullName = '[Null]'
        UnknownName = '[UNKNOWN]'
        DisplayName = #1051#1100#1075#1086#1090#1072
        Forecasting.PrecedingName = '[Preceding]'
        Forecasting.ConsequentName = '[Consequent]'
        Forecasting.Method = dftTripleExponentialSmoothing
        Forecasting.Enabled = False
      ...
      item
        ...
        NullName = '[Null]'
        UnknownName = '[UNKNOWN]'
        DisplayName = #1053#1086#1089#1080#1090'.'#1083#1100#1075#1086#1090#1099
        Forecasting.PrecedingName = '[Preceding]'
        Forecasting.ConsequentName = '[Consequent]'
        Forecasting.Method = dftTripleExponentialSmoothing
        Forecasting.Enabled = False
  ...
  object PivotMap18: TPivotMap
    ...
    AutoSaveMap = False
    AutoExpand = True
    OnAfterRefresh = PivotMap18AfterRefresh
    Left = 40
    Top = 200
  end
  object OD_adr: TOracleDataSet
    SQL.Strings = (
      'select reu,kul,nd '
      'from scott.list_choices t '
      'where t.sel=0')
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      040000000300000003000000524555010000000000030000004B554C01000000
      0000020000004E44010000000000}
    Session = DataModule1.OracleSession1
    Active = True
    Left = 176
    Top = 136
  ...
  object OracleDataSet4: TOracleDataSet
    SQL.Strings = (
      ...
      'where t.id=:id_ and dat is not null'
      ''
      '')
    Optimize = False
    Variables.Data = {0300000001000000040000003A49445F030000000000000000000000}
  ...
  object PivotCube22: TPivotCube
    ...
    Dimensions = <
      ...
      item
        ...
        NullName = '[Null]'
        UnknownName = '[UNKNOWN]'
        DisplayName = #1050#1086#1083'.'#1084#1077#1089'.'
        Forecasting.PrecedingName = '[Preceding]'
        Forecasting.ConsequentName = '[Consequent]'
        Forecasting.Method = dftTripleExponentialSmoothing
        Forecasting.Enabled = False
    ...
    Measures = <
      item
        ...
        DataType = ftFloat
        FormatString = '########0.00'
        DisplayName = #1057#1091#1084#1084#1072' '#1076#1086#1083#1075#1072
      end>
    CubeName = 'test'
    OptimizeLevel = optNormal
    ExtendedMode = True
  ...
  object PivotMap35: TPivotMap
    ...
    AutoSaveMap = False
    AutoExpand = True
    Title = #1055#1088#1086#1074#1077#1088#1082#1072'_TEST_TEST_TEST_TEST'
    OnAfterRefresh = PivotMap18AfterRefresh
    Left = 40
    Top = 264
  end
  ...
  object PivotCube37: TPivotCube
    ...
    Dimensions = <
      item
        ...
        NullName = '[Null]'
        UnknownName = '[UNKNOWN]'
        DisplayName = #1050#1086#1076' '#1044#1086#1082#1091#1084#1077#1085#1090#1072
        Forecasting.PrecedingName = '[Preceding]'
        Forecasting.ConsequentName = '[Consequent]'
        Forecasting.Method = dftTripleExponentialSmoothing
        Forecasting.Enabled = False
      ...
      item
        ...
        NullName = '[Null]'
        UnknownName = '[UNKNOWN]'
        DisplayName = #1058#1080#1087' '#1080#1079#1084'.'
        Forecasting.PrecedingName = '[Preceding]'
        Forecasting.ConsequentName = '[Consequent]'
        Forecasting.Method = dftTripleExponentialSmoothing
        Forecasting.Enabled = False
      ...
      item
        ...
        NullName = '[Null]'
        UnknownName = '[UNKNOWN]'
        DisplayName = #1055#1077#1088#1080#1086#1076' '#1080#1079#1084'.'
        Forecasting.PrecedingName = '[Preceding]'
        Forecasting.ConsequentName = '[Consequent]'
        Forecasting.Method = dftTripleExponentialSmoothing
        Forecasting.Enabled = False
      ...
      item
        ...
        NullName = '[Null]'
        UnknownName = '[UNKNOWN]'
        DisplayName = #1042#1099#1087#1086#1083#1085#1080#1083
        Forecasting.PrecedingName = '[Preceding]'
        Forecasting.ConsequentName = '[Consequent]'
        Forecasting.Method = dftTripleExponentialSmoothing
        Forecasting.Enabled = False
