...
begin
  ...
  begin
    // оплата
      // измерения
    addDimension('mg_name', 'Период', 1);
    addDimension('predp', 'Фонд', 0);
    addDimension('reu', 'УК', 0);
    addDimension('predpr_det', 'Адрес', 0);
    addDimension('org_name', 'Организация', 0);
    addDimension('dat', 'Дата', 0);
    addDimension('var_name', 'Вариант орг.', 0);
    addDimension('dopl_name', 'Период оплаты', 0);
    addDimension('dopl_name', 'Период оплаты', 0);
    addDimension('nm', 'Услуга', 0);
    addDimension('opername', 'Операция', 0);
    addDimension('cd_tp', 'Тип поступления', 0);

      // показатели
    addDimension('summa', 'Сумма', 2);
  end;
end;
