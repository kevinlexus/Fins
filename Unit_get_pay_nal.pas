...
begin
  ...
  begin
    ...
    klsk := DataModule1.OraclePackage1.CallStringFunction('scott.UTILS.GET_K_LSK_ID_BY_LSK', [wwDBEdit3.Text]);
  ...
  begin
    ...
    begin
      ...
      Form_get_cnt_sch.wwDBEdit4.Text :=
        ...
        [wwDBEdit3.Text, OD_usl_chk.FieldByName('fk_usl_chk').AsString, 0, null]));
...
procedure TForm_get_pay_nal.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   if (Key = vk_F12) and (Edit1.Text <> '') then
   begin
