object Form_list_kart: TForm_list_kart
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'DEB_ORG'#9'20'#9#1054#1088#1075'.'#1079#1072#1076#1086#1083#1078#1085'.'
  ...
  object OD_list_kart: TOracleDataSet
    SQL.Strings = (
      'select /*+ FIRST_ROWS */ null as btn, k.rowid, '
      
        'r.name_reu, k.reu, k.k_lsk_id, k.c_lsk_id, k.lsk, k.lsk_ext, k.k' +
        'ul, s.name, ltrim(k.nd,'#39'0'#39') as n_nd, ltrim(k.kw,'#39'0'#39') as n_kw,'
      'k.nd,k.kw, k.kfg,'
      ...
      ''
      '/*or (:var_=3 and k.kul = :kul_ and k.nd = :nd_  and k.kw= :kw_)'
      'or (:var_=2 and k.kul = :kul_ and k.nd = :nd_)'
      'or (:var_=1 and k.kul = :kul_)*/'
      ''
      'or (:var_=6 and'
      ' exists '
    ...
    Optimize = False
    Variables.Data = {
      0300000008000000050000003A5641525F030000000400000000000000000000
      ...
      4B5F49445F030000000000000000000000}
    QBEDefinition.AllowOperators = True
    QBEDefinition.QBEFieldDefs = {
      0400000047000000030000004C534B010100000000030000004B554C00000000
      ...
      
    ...
    object OD_list_kartPN_DT: TDateTimeField
      DisplayWidth = 18
      FieldName = 'PN_DT'
      Visible = False
    end
  ...
  object OD_debits_org: TOracleDataSet
    ...
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      0400000027000000020000004944010000000000020000004344010000000000
  ...
  object OD_rep1: TOracleDataSet
    ...
    Variables.Data = {
      ...
      0000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000056000000030000004C534B010000000000030000004B554C01000000
  ...
  object frxReport_base: TfrxReport
    ...
    ReportOptions.LastChange = 40932.577042789350000000
  ...
  object OD_rep2: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000033000000020000004944010000000000030000004C534B0100000000
