...
uses
  ...
  ExtCtrls, StdCtrls, DBCtrls, DB, OracleData,
//  ActnMan, ActnMenus, XPStyleActnCtrls, ActnList,
  CustomizeDlg, CoolTrayIcon, Oracle, DBCtrlsEh, OleCtl, Utils, StrUtils,
  MemTableDataEh, DataDriverEh, MemTableEh, wwdbedit, Wwintl,
  DVButils, ShellAPI, IdAntiFreezeBase, IdAntiFreeze, frxClass, frxDBSet,
  frxExportCSV, frxExportPDF, frxExportBIFF, frxExportText, frxExportRTF,
  ComObj;
...
type
  ...
  TForm_Main = class(TForm)
    ...
    procedure OracleEvent1Event(Sender: TOracleEvent;
...
implementation
uses Unit_print_opl_xito3,
  Unit_check_days, Unit_check_inkas,
  Unit_form_admin, Unit_print_opl_usl, Unit_print_strah, Unit_generate,
  Unit_print_saldo_houses, Unit_print_saldo_org_usl,
  Unit_form_alert_exit, Unit_about, Unit_print_saldo_usl, Unit_print_plan,
  Unit_form_plan, Unit_print_pred_debit, 
  Unit_print_xito5, Unit_print_opl_xito10_3,
  Unit_form_saldo_check, Unit_print_lg_usl,
  Unit_corrects, Unit_form_messages, Unit1_print_pen, Unit_check_reports,
  ...
  Unit_spr_street, Unit_spr_usl, Unit_spr_rep, Unit_list_set,
  Unit_prep_doc, Unit_corr_sal, Unit_spr_comps, Unit_spr_props,
  Unit_lk_acc, Unit_auto_chrg, Unit_service_cash;
...
begin
  ...
  begin
    msg2('Необходимо выбрать квартиру в списке лицевых счетов!',
...
begin
  ...
  begin
    msg2('Необходимо войти в карточку проживающего!',
     'Внимание', MB_OK+MB_ICONQUESTION);
  end;
end;
...
begin
  ...
  else ShowMessage(Format('Library %s was not found',[LibName]));
end;
...
begin
 ...
 begin
  ...
  begin
    ...
    OD_changes.MasterFields:='c_lsk_id';
    OD_changes.DetailFields:='c_lsk_id';
...
begin
  ...
  begin
    ...
    Form_month_payments.OD_c_kwtp.Master:=Form_list_kart.OD_list_kart;
    Form_month_payments.OD_c_kwtp.MasterFields:='c_lsk_id';
    Form_month_payments.OD_c_kwtp.DetailFields:='c_lsk_id';
    Form_month_payments.OD_c_kwtp.SetVariable('var', 1);
    Form_month_payments.OD_c_kwtp.Active:=false;
    Form_month_payments.OD_c_kwtp.Active:=true;

    Form_month_payments.OD_c_kwtp_mg.Active:=false;
    Form_month_payments.OD_c_kwtp_mg.Active:=true;
  end
  else
  begin
...
begin
  ...
  begin
    ...
    Form_month_payments.OD_c_kwtp.Master:=Form_list_kart.OD_list_kart;
    Form_month_payments.OD_c_kwtp.MasterFields:='lsk';
    Form_month_payments.OD_c_kwtp.DetailFields:='lsk';
    Form_month_payments.OD_c_kwtp.SetVariable('var', 1);
    Form_month_payments.OD_c_kwtp.Active:=false;
    Form_month_payments.OD_c_kwtp.Active:=true;
  end
...
procedure TForm_Main.OracleEvent1Event(Sender: TOracleEvent;        
  const ObjectName: String; const Info: Variant);
var
 ii : Integer;
 IList : TStringList;
...
begin
  if msg3('Вывести всех пользователей из программы?', 'Подтверждение', MB_YESNO+MB_ICONQUESTION) =
    ID_YES then
  begin
    DataModule1.OraclePackage1.CallProcedure(
        'scott.ADMIN.send_message', ['stop']);
  end;
end;
...
//    OD_rep3.Active:=True;
    ...
    frxReport_base.Variables['fio_']:=''''+Form_kart.OD_kart_pr.FieldByName('K_FAM').AsString
...
begin
  ...
  begin
    ...
    begin
      ...
      frxReport_base.Variables['dt1_']:=DataModule1.OraclePackage1.CallDateFunction
        ('scott.UTILS.getS_date_param', ['REP_PREP_DT1']);
...
begin
  ...
  begin
    ...
    frxReport_base.Variables['vc1_']:=DataModule1.OraclePackage1.CallStringFunction
      ('scott.UTILS.getS_str_param', ['REP_PREP_VC']);
    frxReport_base.PrepareReport(true);
    frxReport_base.ShowPreparedReport;
    OD_rep2.Active:=false;
    OD_rep5.Active:=false;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        frxReport_base.Variables['fio_']:=QuotedStr(DataModule1.OraclePackage1.CallStringFunction
          ('scott.UTILS.getS_str_param', ['REP_PREP_VC2']));
        frxReport_base.Variables['dt1_']:=DataModule1.OraclePackage1.CallDateFunction
          ('scott.UTILS.getS_date_param', ['REP_PREP_DT1']);
