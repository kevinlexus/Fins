...
uses DM_module1, Unit_status, Utils, Unit_status_gen;
...
begin
  ...
  DBDateTimeEditEh2.Value:=DataModule1.OraclePackage1.CallDateFunction(
    'scott.INIT.get_period_date', parNone);
end;
...
procedure TForm_gen_current.btn1Click(Sender: TObject);
 ...
 l_state: Integer;
begin
  msg4('Тест1!', 'Внимание!' , MB_ICONEXCLAMATION);
  try
  if (DataModule1.OraclePackage2.Session.Connected=false) then
    begin
      DataModule1.OraclePackage2.Session.Connected:=True;
      msg4('Подключился!', 'Внимание!' , MB_ICONEXCLAMATION)
    end
    else
    begin
    msg4('Уже подключено!', 'Внимание!' , MB_ICONEXCLAMATION);
    end;
  except
  ...
  msg4('Тест2!', 'Внимание!' , MB_ICONEXCLAMATION);
  l_state:=DataModule1.OraclePackage2.CallIntegerFunction
     ('scott.Utils.set_base_state_gen', [1]);
  msg4('Тест3!', 'Внимание!' , MB_ICONEXCLAMATION);
