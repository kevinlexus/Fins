  ...
  object OD_c_kwtp: TOracleDataSet
    SQL.Strings = (
      ...
      't.num_doc, t.dat_doc'
        ...
        '  from scott.c_kwtp t, scott.kart k, scott.t_org c, scott.c_comp' +
        's m, scott.oper p'
      'where k.lsk=t.lsk and t.oper=p.oper(+)'
      
        'and  ((:var =0) or (:var =1 and  k.c_lsk_id=:c_lsk_id)) and t.nk' +
        'om=m.nkom and m.fk_org=c.id'
      'order by t.ts')
    Optimize = False
    Variables.Data = {
      0300000002000000040000003A56415203000000000000000000000009000000
      3A435F4C534B5F4944030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
