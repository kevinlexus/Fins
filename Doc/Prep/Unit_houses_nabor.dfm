object Form_houses_nabor: TForm_houses_nabor
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NM'#9'41'#9#1059#1089#1083#1091#1075#1072#9'F'
          'VVOD_NUM'#9'29'#9#8470' '#1074#1074#1086#1076#1072#9'F')
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Height = 514
        Selected.Strings = (
          'PARNAME'#9'25'#9#1055#1072#1088#1072#1084#1077#1090#1088
          'VAL'#9'25'#9#1047#1085#1072#1095#1077#1085#1080#1077
          'NM'#9'22'#9#1045#1076'.'#1080#1079#1084'.')
        IniAttributes.Delimiter = ';;'
        TitleColor = clBtnFace
        FixedCols = 0
        ShowHorzScrollBar = True
        ...
        Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgWordWrap, dgPerfectRowFit, dgShowCellHint, dgProportionalColResize]
        TabOrder = 0
        TitleAlignment = taLeftJustify
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
  ...
  object wwDBLookupCombo4: TwwDBLookupCombo
    ...
    OnNotInList = wwDBLookupCombo4NotInList
  end
  object Panel2: TPanel
    ...
    object wwDBGrid1: TwwDBGrid
      ...
      Height = 475
      ControlType.Strings = (
        'HOUSE_TYPE;CheckBox;1;0'
        'PASP_NAME;CustomEdit;wwDBLookupCombo4;F'
        'KRAN1;CheckBox;1;0')
      Selected.Strings = (
        'NAME_REU'#9'8'#9#1046#1069#1054
        'NAME'#9'18'#9#1059#1083#1080#1094#1072
        'N_ND'#9'4'#9#1044#1086#1084
        'HOUSE_TYPE'#9'4'#9#1054#1073#1097'?'
        'UCH'#9'3'#9#1059#1095'.'
        'PASP_NAME'#9'11'#9#1055#1072#1089#1087'.'#1057#1090#1086#1083
        'ID'#9'10'#9'ID '#1076#1086#1084#1072
        'KRAN1'#9'10'#9#1050#1088#1072#1085' '#1080#1079' '#1089#1080#1089#1090'~'#1086#1090#1086#1087#1083#1077#1085#1080#1103
        'K_LSK_ID'#9'10'#9'K_LSK_ID')
      IniAttributes.Delimiter = ';;'
      TitleColor = clBtnFace
      FixedCols = 3
      ShowHorzScrollBar = True
  ...
  object OD_houses: TOracleDataSet
    SQL.Strings = (
        ...
        'select t.rowid, t.house_type, t.id, r.name_reu, t.kul, s.name, t' +
        '.nd, '
      
        ' LTRIM(t.nd,'#39'0'#39') as n_nd, t.minlsk, t.maxlsk, t.uch, nvl(t.psch,' +
        '0) as psch,'
      ' t.fk_pasp_org, o.name as pasp_name, t.kran1, t.k_lsk_id'
      
        ' from scott.c_houses t, scott.spul s, scott.s_reu_trest r, scott' +
        '.t_org o'
      'where t.kul=s.id and t.reu=r.reu and t.fk_pasp_org=o.id(+) and'
      '(:var1_=0 or (:var1_=1 and nvl(t.psch,0)<>1))'
      
        'and (:flt_reu_ is not null and t.reu=:flt_reu_ or :flt_reu_ is  ' +
        'null)'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      004B554C010000000000080000004E414D455F52455501000000000004000000
      505343480100000000000B000000464B5F504153505F4F524701000000000009
      000000504153505F4E414D45010000000000050000004B52414E310100000000
      00080000004B5F4C534B5F4944010000000000}
    ...
    Top = 24
    object OD_housesNAME_REU: TStringField
  ...
  object OD_pasp: TOracleDataSet
    ...
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      0400000027000000020000004944010000000000040000004E414D4501000000
      ...
      434845545F534348455432010000000000}
    Session = DataModule1.OracleSession1
    DesignActivation = True
    Active = True
    Left = 72
  ...
  object OD_objxpar: TOracleDataSet
    SQL.Strings = (
      'select t.id, u.name as parname, u.val_tp,'
      ...
      '     when u.val_tp = '#39'DT'#39' then to_char(t.d1,'#39'DD.MM.YYYY'#39')'
        ...
        '     end as val, u2.nm from scott.t_objxpar t, scott.u_list u, s' +
        'cott.u_list u2,'
      'scott.u_listtp tp'
      'where tp.cd='#39'house_params'#39' and tp.id=u.fk_listtp'
      'and t.fk_list=u.id'
    ...
    Variables.Data = {
      ...
      00}
    QBEDefinition.QBEFieldDefs = {
      0400000005000000020000004944010000000000070000005041524E414D4501
      00000000000600000056414C5F54500100000000000300000056414C01000000
      0000020000004E4D010000000000}
    Master = OD_houses
  ...
  object OD_par_value: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      040000000E000000020000004944010000000000020000005331010000000000
