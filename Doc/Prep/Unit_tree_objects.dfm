object Form_tree_objects: TForm_tree_objects
  ...
  object OD_data: TOracleDataSet
    ...
    Variables.Data = {
      ...
      0000000000040000003A43445F03000000040000005300000000000000050000
      ...
      000000000000}
    QBEDefinition.QBEFieldDefs = {
      0400000005000000030000004C534B010000000000070000004E414D455F5354
      010000000000030000004B505201000000000003000000414452010000000000
      020000004D47010000000000}
    Session = DataModule1.OracleSession1
  ...
  object OD_usl_olap: TOracleDataSet
    SQL.Strings = (
        ...
        'select u.usl, TRIM(u.nm)||DECODE(u.ed_izm,NULL,'#39#39','#39' ('#39'||TRIM(u.e' +
        'd_izm)||'#39')'#39') as nm'
      ' from scott.usl u'
      'union all'
  ...
  object OD_uslm_olap: TOracleDataSet
    SQL.Strings = (
        ...
        'select u.uslm, TRIM(u.nm1)||DECODE(u.ed_izm,NULL,'#39#39','#39' ('#39'||TRIM(u' +
        '.ed_izm)||'#39')'#39') as nm1'
  ...
  object OD_c_kart_pr: TOracleDataSet
    SQL.Strings = (
        ...
        'select a.*, r.name as rel_name from scott.a_kart_pr a, scott.rel' +
        'ations r'
    ...
    QBEDefinition.QBEFieldDefs = {
      040000002C000000030000004C534B0100000000000200000049440100000000
      ...
      00005354415455535F44415442010000000000}
    MasterFields = 'lsk;mg'
    QueryAllRecords = False
    UpdatingTable = 'scott.nabor n'
    Session = DataModule1.OracleSession1
