...
uses
  ...
  Wwdbigrd, Wwdbgrid, frxExportText, frxExportCSV;
...
begin
  ...
  Button2.Left:=Button3.Left-Button2.Width-15;
...
begin
  ...
  if (DataModule1.OraclePackage1.CallIntegerFunction
            ('scott.init.is_allow_acc', ['drb1_Сохранить_шаблон'])=0) then
...
procedure TForm_olap.Button5Click(Sender: TObject);
begin
    TfrxReport(Form_tree_objects.fr_).Print;
end;
