object Form_spr_comps: TForm_spr_comps
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Height = 365
    ControlType.Strings = (
      'NAME_OPER;CustomEdit;wwDBLookupCombo1;F'
      'NAME_ORG;CustomEdit;wwDBLookupCombo2;F')
    Selected.Strings = (
      'NKOM'#9'4'#9#8470' '#1082#1086#1084#1087'.'#9'F'
      'NINK'#9'7'#9#8470' '#1089#1083#1077#1076'.~'#1080#1085#1082#1072#1089#1089#1072#1094#1080#1080#9'F'
      'NKVIT'#9'10'#9#8470' '#1089#1083#1077#1076'.~'#1082#1074#1080#1090#1072#1085#1094#1080#1080#9'F'
      'CD'#9'25'#9#1050#1086#1076' CD'#9'F'
      'NAME_OPER'#9'22'#9#1069#1082#1089#1082#1083#1102#1079#1080#1074#1085#1072#1103'~'#1086#1087#1077#1088#1072#1094#1080#1103#9'F'
      'NAME_ORG'#9'21'#9#1054#1088#1075#1072#1085#1080#1079#1072#1094#1080#1103#9'F'
      'PERIOD'#9'10'#9#1056#1072#1073'.~'#1087#1077#1088#1080#1086#1076#9'F')
    IniAttributes.Delimiter = ';;'
    TitleColor = clBtnFace
    FixedCols = 0
    ShowHorzScrollBar = True
    Align = alClient
    DataSource = DS_c_comps
    Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgCancelOnExit, dgWordWrap, dgProportionalColResize]
    TabOrder = 0
  ...
  object OD_c_comps: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      06000000504552494F44010000000000}
  ...
  object OD_org: TOracleDataSet
    ...
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      0400000028000000020000004344010000000000020000004944010000000000
