object Form_find_adr: TForm_find_adr
  ...
  object OD_streets: TOracleDataSet
    SQL.Strings = (
      ...
      ' where '
        ...
        ' (:flt_reu_ is not null and exists (select * from scott.c_houses' +
        ' c where c.kul=s.id'
      ' and c.reu=:flt_reu_) or :flt_reu_ is null)'
      'order by name ')
    Optimize = False
    Variables.Data = {
  ...
  object OD_houses: TOracleDataSet
    SQL.Strings = (
        ...
        'select distinct k.reu, LTRIM(k.nd,'#39'0'#39')||'#39' '#1046#1069#1054'-'#39'||s.name_reu as n' +
        'd, '
      
        ' LTRIM(k.nd,'#39'0'#39') as nd2, k.nd as nd_id, k.id as house_id, nvl(k.' +
        'psch,0) as psch'
      'from scott.c_houses k, scott.s_reu_trest s'
      'where  k.kul=:id  and k.reu=s.reu '
      
        'and (:flt_reu_ is not null and k.reu=:flt_reu_ or :flt_reu_ is n' +
        'ull)'
      'order by k.nd, nvl(k.psch,0)')
    Optimize = False
    Variables.Data = {
      0300000002000000030000003A49440500000005000000303031200000000000
      090000003A464C545F5245555F050000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
  ...
  object OD_kw: TOracleDataSet
    SQL.Strings = (
      'select LTRIM(k.kw,'#39'0'#39') as kw, k.lsk, k.kw as kw_id, k.fio'
      ' from scott.kart k'
  ...
  object OD_t_org: TOracleDataSet
    SQL.Strings = (
      ...
      'union all '
      'select 1 as ord, t.id, t.reu, t.name  from scott.t_org t'
