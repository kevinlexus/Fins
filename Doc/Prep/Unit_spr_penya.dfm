object Form_spr_penya: TForm_spr_penya
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Height = 313
    ControlType.Strings = (
      'DAT1;CustomEdit;wwDBDateTimePicker1;F'
      'DAT2;CustomEdit;wwDBDateTimePicker1;F')
    Selected.Strings = (
      'PROC'#9'9'#9'1/300~'#1089#1090#1072#1074#1082#1080' '#1088#1077#1092#1080#1085#1072#1085#1089#9'F'
      'DAT1'#9'11'#9#1053#1072#1095'.~'#1076#1072#1090#1072#9'F'
      'DAT2'#9'10'#9#1050#1086#1085'.~'#1076#1072#1090#1072#9'F'
      'MONTH_PEN'#9'10'#9#1052#1077#1089#1103#1094#1077#1074'~'#1086#1090#1089#1088#1086#1095#1082#1080#9'F')
  ...
  object OD_data: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      04000000040000000400000050524F4301000000000004000000444154310100
