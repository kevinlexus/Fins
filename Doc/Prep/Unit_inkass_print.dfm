object Form_inkass_print: TForm_inkass_print
  ...
  object OD_inkass: TOracleDataSet
    SQL.Strings = (
      ...
      'sum(c.penya) as penya, t.oper, '
        ...
        '.nink, t.nkom, t.nkvit,'
      ' to_char(t.ts,'#39'HH:MI'#39') as wr '
      ...
      'and t.nink =:nink and k.kul=s.id'
        ...
        'group by c.c_kwtp_id, t.lsk, s.name||'#39' '#39'||ltrim(k.nd,'#39'0'#39')||'#39'-'#39'||' +
        'ltrim(k.kw,'#39'0'#39') , '
      ...
      'from scott.c_kwtp c, scott.kart k, scott.spul s'
    ...
    QBEDefinition.QBEFieldDefs = {
      040000000C0000000500000053554D4D410100000000000500000050454E5941
      ...
      0009000000435F4B5754505F4944010000000000}
    Master = OD_ink
    MasterFields = 'nink'
    Session = DataModule1.OracleSession1
    Active = True
  ...
  object OD_inkass2: TOracleDataSet
    SQL.Strings = (
        ...
        's summa, sum(c.penya) as penya'
      'from scott.c_kwtp_mg c, scott.oper o'
      'where c.oper=o.oper and nkom = scott.init.get_nkom()'
      'and c.nink = :nink'
      'group by c.nkom, c.nink, c.dat_ink, c.oper, o.naim')
    Optimize = False
    Variables.Data = {0300000001000000050000003A4E494E4B030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      ...
      00004441545F494E4B010000000000}
    Master = OD_ink
    MasterFields = 'nink'
    Session = DataModule1.OracleSession1
    Active = True
