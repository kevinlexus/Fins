object Form_spr_users: TForm_spr_users
  ...
  object GroupBox2: TGroupBox
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView1: TcxGridDBTableView
        ...
        DataController.DataSource = DS_c_users
  ...
  object GroupBox3: TGroupBox
    ...
    object wwDBGrid2: TwwDBGrid
      ...
      Selected.Strings = (
        ...
        'FK_COMP'#9'11'#9#1050#1086#1084#1087#1100#1102#1090#1077#1088#9'F')
      IniAttributes.Delimiter = ';;'
      TitleColor = clBtnFace
      FixedCols = 0
      ShowHorzScrollBar = True
      Align = alClient
      DataSource = DS_user_perm
  ...
  object GroupBox4: TGroupBox
    ...
    object wwDBGrid3: TwwDBGrid
      ...
      TitleButtons = False
      UseTFields = False
      OnMouseDown = wwDBGrid3MouseDown
    end
  end
  object GroupBox5: TGroupBox
    ...
    object DBLookupComboboxEh1: TDBLookupComboboxEh
      ...
      KeyField = 'ID'
      ListField = 'NAME'
      ListSource = DS_permtp
      TabOrder = 0
      Visible = True
      OnCloseUp = DBLookupComboboxEh1CloseUp
    end
  end
  object DS_c_users: TwwDataSource
    DataSet = OD_c_users
    Left = 40
    Top = 128
  end
  object OD_s_reu_trest: TOracleDataSet
    SQL.Strings = (
        ...
        'select null as id, null as nkom, s.reu, s.reu||'#39'-'#39'||s.name_reu a' +
        's name_org'
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000004000000030000005245550100000000000200000049440100000000
      00080000004E414D455F4F5247010000000000040000004E4B4F4D0100000000
      00}
    ...
    Left = 680
    Top = 120
    object OD_s_reu_trestNAME_ORG: TStringField
      DisplayLabel = #1053#1072#1080#1084#1077#1085#1086#1074#1072#1085#1080#1077
      DisplayWidth = 35
      FieldName = 'NAME_ORG'
      Size = 35
    end
    object OD_s_reu_trestNKOM: TStringField
      DisplayWidth = 1
      FieldName = 'NKOM'
      Visible = False
      Size = 1
    end
    object OD_s_reu_trestID: TStringField
      DisplayWidth = 1
      FieldName = 'ID'
      Visible = False
      Size = 1
  ...
  object OD_user_perm: TOracleDataSet
    SQL.Strings = (
      
        'select c.*, c.rowid, t.reu||'#39'-'#39'||t.name_reu as name_reu, o.name ' +
        'as name_org'
      'from scott.c_users_perm c, scott.s_reu_trest t, scott.t_org o'
      'where c.user_id = :user_id and c.fk_perm_tp=:permtp'
      'and c.fk_reu=t.reu(+) and c.fk_pasp_org=o.id(+)'
      'order by t.name_reu, o.name')
    Optimize = False
    Variables.Data = {
      0300000002000000080000003A555345525F4944040000000800000000000000
      00006C4000000000070000003A5045524D5450030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      
      50010000000000}
    RefreshOptions = [roAfterInsert]
    CommitOnPost = False
    Session = DataModule1.OracleSession1
    ...
    object OD_user_permNAME_ORG: TStringField
      DisplayLabel = #1054#1088#1075#1072#1085#1080#1079#1072#1094#1080#1103
      DisplayWidth = 64
      FieldName = 'NAME_ORG'
      Size = 64
    end
    object OD_user_permFK_COMP: TStringField
  ...
  object DS_user_perm: TwwDataSource
    DataSet = OD_user_perm
    Left = 272
    Top = 128
  end
  object OD_t_org: TOracleDataSet
    SQL.Strings = (
        ...
        'select t.id, null as nkom, null as reu, t.name as name_org from ' +
        'scott.t_org t, scott.t_org_tp p'
      'where t.fk_orgtp=p.id and p.cd='#39#1055#1072#1089#1087#1086#1088#1090#1085#1099#1081' '#1089#1090#1086#1083#39)
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      0400000004000000030000005245550100000000000200000049440100000000
      00080000004E414D455F4F5247010000000000040000004E4B4F4D0100000000
    ...
    object OD_t_orgNKOM: TStringField
      FieldName = 'NKOM'
      Size = 1
    end
  end
  object DS_t_org: TwwDataSource
    DataSet = OD_t_org
    Left = 712
    Top = 152
  end
  object OD_permtp: TOracleDataSet
    SQL.Strings = (
      'select t.* from scott.u_list t, scott.u_listtp tp'
      'where t.fk_listtp=tp.id and tp.cd='#39#1058#1080#1087' '#1088#1072#1079#1088#1077#1096#1077#1085#1080#1103#39)
    Optimize = False
    SequenceField.ApplyMoment = amOnNewRecord
    QBEDefinition.QBEFieldDefs = {
      0400000006000000020000004944010000000000020000004344010000000000
      040000004E414D45010000000000020000004E4D01000000000009000000464B
      5F4C4953545450010000000000030000004E5050010000000000}
    Session = DataModule1.OracleSession1
    Left = 360
    Top = 16
    object OD_permtpID: TFloatField
      FieldName = 'ID'
      Required = True
    end
    object OD_permtpNAME: TStringField
      FieldName = 'NAME'
      Required = True
      Size = 96
    end
    object OD_permtpCD: TStringField
      FieldName = 'CD'
      Required = True
      Size = 32
    end
  end
  object DS_permtp: TwwDataSource
    DataSet = OD_permtp
    Left = 392
    Top = 16
  end
  ...
  object OD_c_comps: TOracleDataSet
    SQL.Strings = (
        ...
        'select null as id, nkom, null as reu, t.nkom as name_org from sc' +
        'ott.c_comps t')
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      0400000004000000030000005245550100000000000200000049440100000000
    ...
    Left = 680
    Top = 184
    object OD_c_compsID: TStringField
      FieldName = 'ID'
      Required = True
      Size = 3
    end
  ...
  object DS_c_comps: TwwDataSource
    DataSet = OD_c_comps
    Left = 712
    Top = 184
  end
