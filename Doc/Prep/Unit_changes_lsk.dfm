object Form_changes_lsk: TForm_changes_lsk
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      'LSK'#9'9'#9#1051'/C'#9'F'
      'DTEK'#9'9'#9#1044#1072#1090#1072#9'F'
      'SUMMA'#9'10'#9#1057#1091#1084#1084#1072#9'F'
      'PROC'#9'7'#9#1055#1088#1086#1094#1077#1085#1090#9'F'
      'CNT_DAYS'#9'5'#9#1050#1086#1083'-'#1074#1086'~'#1076#1085#1077#1081#9'F'
      'nm'#9'15'#9#1059#1089#1083#1091#1075#1072#9'F'
      'NAME'#9'16'#9#1054#1088#1075#1072#1085#1080#1079#1072#1094#1080#1103#9'F'
      'MGCHANGE'#9'6'#9#1055#1088#1086#1074#1077#1076#1077#1085#1086'~'#1087#1077#1088#1080#1086#1076#1086#1084#9'F'
      'MG2'#9'6'#9#1047#1072' '#1087#1077#1088#1080#1086#1076#9'F'
      'TS'#9'9'#9#1048#1079#1084#1077#1085#1077#1085#1086#9'F'
      'FIO'#9'12'#9#1055#1086#1083#1100#1079#1086#1074#1072#1090#1077#1083#1100#9'F'
      'TEXT'#9'19'#9#1055#1088#1080#1084#1077#1095#1072#1085#1080#1077#9'F'
      'DOC_ID'#9'6'#9#8470' '#1076#1086#1082#9'F'
      'ID'#9'8'#9#8470' '#1089#1090#1088#1086#1082#1080#9'F')
  ...
  object wwDBRichEdit1: TwwDBRichEdit
    ...
    RichEditVersion = 2
    Data = {
      
      74315C7061720D0A7D0D0A00}
  end
  object OD_changes: TOracleDataSet
    SQL.Strings = (
      ...
      'u.nm, s.name, u.name as fio, t.ts, d.text, t.id, t.doc_id'
      'from '
      'scott.c_change t, scott.kart k, '
        ...
        'where k.lsk=t.lsk  and d.id=t.doc_id  and  ((k.c_lsk_id=:c_lsk_i' +
    ...
    Variables.Data = {
      ...
      090000003A435F4C534B5F4944030000000000000000000000}
    QBEDefinition.QBEFieldDefs = {
      040000000E0000000500000053554D4D41010000000000020000004E4D010000
  ...
  object wwFilterDialog1: TwwFilterDialog
    ...
    SQLTables = <
      item
        TableName = 'scott.spul'
        TableAliasName = 'p'
      end
      item
        TableName = 'scott.kart'
        TableAliasName = 'k'
      end
      item
        TableName = 'scott.c_change'
        TableAliasName = 't'
      end
      item
        TableName = 'scott.sprorg'
        TableAliasName = 's'
      end
      item
        TableName = 'scott.c_change_docs'
        TableAliasName = 'd'
      end
      item
        TableName = 'scott.usl'
