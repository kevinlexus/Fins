...
begin
  ...
  begin  // из текущего в архив
    ...
    change_alias(OD_chargepay,'(select mg, sum(summa) as summa from scott.c_chargepay where period=(select period from scott.params)',
...
var
  ...
  sum_pay_: Double;
begin
  //Обновляем движение по лицевому счету
