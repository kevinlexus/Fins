...
uses
  ...
  Menus, Oracle, cxGraphics, cxControls, cxLookAndFeels,
  ...
  cxGridLevel, cxClasses, cxGridCustomView, cxGrid, cxPropertiesStore,
  cxGridCustomLayoutView, cxGridCardView, cxCheckBox, cxDBLookupComboBox;
...
uses Unit_change_house_nabor2, DM_module1, Unit_find_adr, Unit_Mainform,
