object Form_recv_pay_bank: TForm_recv_pay_bank
  ...
  object OD_reg: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      0400000005000000040000004E494E4B010000000000070000004441545F494E
      4B0100000000000500000053554D4D410100000000000500000050454E594101
      00000000000900000053554D4D415F495447010000000000}
    Session = DataModule1.OracleSession1
    DesignActivation = True
    Active = True
    Left = 408
    Top = 184
    object OD_regNINK: TFloatField
      FieldName = 'NINK'
    end
    object OD_regDAT_INK: TDateTimeField
      FieldName = 'DAT_INK'
    end
    object OD_regSUMMA: TFloatField
      FieldName = 'SUMMA'
    end
    object OD_regPENYA: TFloatField
      FieldName = 'PENYA'
    end
    object OD_regSUMMA_ITG: TFloatField
      FieldName = 'SUMMA_ITG'
    end
  end
