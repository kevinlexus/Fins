object Form_edit_request: TForm_edit_request
  Left = 461
  Top = 117
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object wwDBEdit1: TwwDBEdit
        ...
        Height = 21
        DataField = 'NAME'
        DataSource = Form_requests.DS_request
        TabOrder = 0
      ...
      object wwDBEdit2: TwwDBEdit
        ...
        Height = 21
        DataField = 'F_S1'
        DataSource = Form_requests.DS_doc_det
        TabOrder = 5
        UnboundDataType = wwDefault
        WantReturns = False
        WordWrap = False
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid1: TwwDBGrid
        ...
        Height = 217
        ControlType.Strings = (
          'WORK_NAME;CustomEdit;wwDBLookupComboDlg1;F')
        Selected.Strings = (
          'RN'#9'4'#9#8470
          'WORK_NAME'#9'79'#9#1053#1072#1080#1084#1077#1085#1086#1074#1072#1085#1080#1077' '#1088#1072#1073#1086#1090#1099)
    ...
    object TabSheet4: TTabSheet
      ...
      object wwDBGrid2: TwwDBGrid
        ...
        Height = 253
        Selected.Strings = (
          'TS'#9'18'#9#1044#1072#1090#1072'-'#1074#1088#1077#1084#1103
          'FUNCT_NAME'#9'18'#9#1060#1091#1085#1082#1094#1080#1103
          'ROLE_NAME'#9'22'#9#1056#1086#1083#1100
          'USERNAME'#9'23'#9#1060'.'#1048'.'#1054'.')
        IniAttributes.Delimiter = ';;'
        TitleColor = clBtnFace
        FixedCols = 0
        ShowHorzScrollBar = True
