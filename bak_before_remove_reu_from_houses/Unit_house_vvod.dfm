object Form_house_vvod: TForm_house_vvod
  ...
  object OD_vvod: TOracleDataSet
    SQL.Strings = (
        ...
        'select h.kul, h.reu, t.name_reu, s.name, ltrim(h.nd,'#39'0'#39') as nd, ' +
        's.name||'#39' '#39'||ltrim(h.nd,'#39'0'#39') as adr, h.nd as nd_id, r.id, h.id a' +
        's house_id, '
      
        '  r.nm as vvod, r.usl, r.kub, r.edt_norm, r.kub_dist, r.vvod_num' +
        ', r.kub_man, r.kpr, r.kub_sch, r.sch_cnt,'
      
        '  r.sch_kpr, r.cnt_lsk, k.opl, r.rowid, r.vol_add, r.sch_add, r.' +
        'kub_fact, r.vol_add_fact, r.kub_nrm_fact, r.kub_sch_fact,r.itg_f' +
        'act, r.opl_add,'
      
        '  r.kub_norm, r.use_sch, r.dist_tp, r.kub_norm+r.kub_sch+r.kub_a' +
        'r as all_vl, r.opl_ar, r.kub_ar, r.kub_ar_fact, r.limit_proc, r.' +
        'wo_limit, r.rowid'
      
        'from (select c.*, nvl(u.nm, '#39#1055#1086#1076#1098#1077#1079#1076#39') as nm, u.npp from scott.c' +
        '_vvod c left join scott.usl u on c.usl=u.usl) r, scott.c_houses ' +
        'h, scott.spul s, scott.s_reu_trest t,'
      
        ' (select sum(opl) as opl, house_id from scott.kart k, scott.v_ls' +
        'k_tp tp'
      '  where k.psch <> 9 and k.fk_tp=tp.id(+) and tp.cd='#39'LSK_TP_MAIN'#39
      '  group by k.house_id) k '
      
        'where h.reu=t.reu and h.id=r.house_id(+) and h.id = k.house_id(+' +
        ') and h.kul=s.id(+) and nvl(h.psch,0) <> 1'
      
        'and (:var_=0 or :var_=1 and (nvl(r.kub,0)<>0 or nvl(r.vol_add,0)' +
        '<>0))'
      
        'and (:flt_reu_ is not null and h.reu=:flt_reu_ or :flt_reu_ is  ' +
        'null)'
      'and (:flt_house_ <> -1 and h.id=:flt_house_ or :flt_house_ = -1)'
      
        'and (:flt_kul_ is not null and h.kul=:flt_kul_ or :flt_kul_ is  ' +
        'null)'
      
        'order by s.name, scott.utils.f_order(h.nd, 6), r.npp, nvl(r.vvod' +
        '_num,0)')
    Optimize = False
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      040000002800000003000000524555010000000000040000004E414D45010000
      ...
      
      ...
      494D4954010000000000080000004544545F4E4F524D010000000000}
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo1: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              #1056#1115#1057#8218#1057#8225#1056#181#1057#8218' '#1056#1109' '#1057#1026#1056#176#1057#1027#1056#1111#1057#1026#1056#181#1056#1169#1056#181#1056#187#1056#181#1056#1029#1056#1105#1056#1105' '#1056#1109#1056#177#1057#1033#1056#181#1056#1112#1056#1029#1057#8249#1057#8230' '#1056#1111#1056#1109#1056#1108 +
              #1056#176#1056#183#1056#176#1057#8218#1056#181#1056#187#1056#181#1056#8470' '#1056#1111#1056#1109' '#1057#1107#1057#1027#1056#187#1057#1107#1056#1110#1056#176#1056#1112' '#1056#183#1056#176' [frxDBDataset1."MG"]')
          ParentFont = False
          Style = 'Title'
          VAlign = vaCenter
        end
  ...
  object OD_rep: TOracleDataSet
    SQL.Strings = (
      'select '
        ...
        'h.kul, h.reu, t.name_reu, s.name, ltrim(h.nd,'#39'0'#39') as nd, s.name|' +
        '|'#39' '#39'||ltrim(h.nd,'#39'0'#39') as adr, h.nd as nd_id, r.id, h.id as house' +
        '_id, '
      
        '  r.nm as vvod, r.usl, r.kub, r.kub_dist, r.vvod_num, r.kub_man,' +
        ' r.kpr, r.kub_sch, r.sch_cnt,'
        ...
        '  r.kub_norm, r.use_sch, r.dist_tp, r.kub_norm+r.kub_sch+r.kub_a' +
        'r as all_vl, r.opl_ar, r.kub_ar, r.kub_ar_fact,'
      
        '  scott.utils.month_name(substr(:mg, 5, 2))||'#39' '#39'||substr(:mg,1,4' +
        ')||'#39#1075'.'#39' as mg'
      ''
      ''
      
        'from (select c.*, u.npp, u.nm from scott.c_vvod c, scott.usl u w' +
        'here c.usl=u.usl'
      
        'and (:var_=0 or :var_=1 and (nvl(c.kub,0)<>0 or nvl(c.vol_add,0)' +
        '<>0))'
      ') r, scott.c_houses h, scott.spul s, scott.s_reu_trest t,'
      ' (select sum(opl) as opl, house_id from scott.kart k '
      '  where k.psch <> 9 group by k.house_id) k'
      
        'where h.reu=t.reu and h.id=r.house_id and h.id = k.house_id(+) a' +
        'nd h.kul=s.id(+) and nvl(h.psch,0) <> 1'
      ''
      ...
      'and (:flt_house_ <> -1 and h.id=:flt_house_ or :flt_house_ = -1)'
        ...
        'and (:flt_kul_ is not null and t.reu=:flt_kul_ or :flt_kul_ is  ' +
        'null)'
