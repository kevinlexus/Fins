object Form_corr_sal: TForm_corr_sal
  ...
  object GroupBox2: TGroupBox
    ...
    object wwDBGrid2: TwwDBGrid
      ...
      Height = 208
      Selected.Strings = (
        'FK_DOC'#9'10'#9#1050#1086#1076#9'F'
        'TEXT'#9'36'#9#1054#1087#1080#1089#1072#1085#1080#1077#9'F'
        'NAME_REU'#9'19'#9#1059#1050#9'F'
        'NAME_USL'#9'34'#9#1059#1089#1083#1091#1075#1072#9'F'
        'NAME_ORG'#9'21'#9#1054#1088#1075#1072#1085#1080#1079#1072#1094#1080#1103#9'F'
        'SUMMA'#9'14'#9#1057#1091#1084#1084#1072#9'F')
      IniAttributes.Delimiter = ';;'
      TitleColor = clBtnFace
      FixedCols = 0
      ShowHorzScrollBar = True
  ...
  object OD_saldo: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      040000000D0000000300000055534C010000000000080000004E414D455F5553
      ...
      00000000080000004E414D455F52455501000000000002000000504E01000000
      0000}
