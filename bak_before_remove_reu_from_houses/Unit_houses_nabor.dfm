object Form_houses_nabor: TForm_houses_nabor
    ...
    object TabSheet2: TTabSheet
      ...
      object wwDBGrid4: TwwDBGrid
        ...
        Selected.Strings = (
          ...
          'NM'#9'27'#9#1059#1089#1083#1091#1075#1072#9'F'
          'VVOD_NUM'#9'19'#9#8470' '#1074#1074#1086#1076#1072#9'F')
  ...
  object Panel2: TPanel
    ...
    object wwDBGrid1: TwwDBGrid
      ...
      ControlType.Strings = (
        ...
        'KRAN1;CheckBox;1;0'
        'OTHER_NAME;CustomEdit;wwDBLookupCombo1;F')
      Selected.Strings = (
        'NAME_REU'#9'8'#9#1046#1069#1054#9#9
        'NAME'#9'18'#9#1059#1083#1080#1094#1072#9#9
        'N_ND'#9'4'#9#1044#1086#1084#9#9
        'HOUSE_TYPE'#9'4'#9#1054#1073#1097'?'#9#9
        'UCH'#9'3'#9#1059#1095'.'#9#9
        'PASP_NAME'#9'11'#9#1055#1072#1089#1087'.'#1057#1090#1086#1083#9#9
        'OTHER_NAME'#9'11'#9#1055#1088#1086#1095#1080#1077' '#1086#1088#1075'.'#9#9
        'ID'#9'10'#9'ID '#1076#1086#1084#1072#9#9
        'KRAN1'#9'10'#9#1050#1088#1072#1085' '#1080#1079' '#1089#1080#1089#1090'~'#1086#1090#1086#1087#1083#1077#1085#1080#1103#9#9
        'K_LSK_ID'#9'10'#9'K_LSK_ID'#9#9)
      IniAttributes.Delimiter = ';;'
      TitleColor = clBtnFace
      FixedCols = 3
      ShowHorzScrollBar = True
  ...
  object wwDBLookupCombo1: TwwDBLookupCombo
    ...
    DropDownAlignment = taLeftJustify
    Selected.Strings = (
      'NAME'#9'64'#9'NAME'#9'F'#9)
    DataField = 'FK_OTHER_ORG'
    DataSource = DS_houses
    LookupTable = OD_other
    LookupField = 'NAME'
    TabOrder = 4
    AutoDropDown = False
    ShowButton = True
  ...
  object OD_houses: TOracleDataSet
    SQL.Strings = (
        ...
        '.t_org o, scott.t_org o2'
      
        'where t.kul=s.id and t.reu=r.reu and t.fk_pasp_org=o.id(+) and t' +
        '.fk_other_org=o2.id(+) and'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00080000004B5F4C534B5F49440100000000000A0000004F544845525F4E414D
      450100000000000C000000464B5F4F544845525F4F5247010000000000}
  ...
  object OD_pasp: TOracleDataSet
    ...
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      040000002C000000020000004944010000000000040000004E414D4501000000
