object Form_version: TForm_version
  Left = 218
  Top = 433
  ...
  object OData: TOracleDataSet
    SQL.Strings = (
      'select scott.init.get_dbid as dbid from dual')
    Optimize = False
    QBEDefinition.QBEFieldDefs = {04000000010000000400000044424944010000000000}
    Session = DataModule1.OracleSession1
    object ODataDBID: TStringField
      FieldName = 'DBID'
      Size = 4000
    end
  end
