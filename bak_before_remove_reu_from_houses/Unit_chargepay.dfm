  ...
  object PageControl1: TPageControl
    ...
    object TabSheet5: TTabSheet
      ...
      object wwDBGrid6: TwwDBGrid
        ...
        Height = 459
        Selected.Strings = (
          'MG3'#9'10'#9#1055#1077#1088#1080#1086#1076#9'F'
          'TP_NAME'#9'13'#9#1058#1080#1087#9'F'
          'DTEK'#9'12'#9#1044#1072#1090#1072#9'F'
          'NKVIT'#9'15'#9#8470' '#1050#1074#1080#1090#9'F'
          'SUMMA'#9'12'#9#1057#1091#1084#1084#1072#9'F'
          'PN'#9'15'#9#1055#1077#1085#1103#9'F'
          'MG1'#9'13'#9#1047#1072' '#1087#1077#1088#1080#1086#1076#9'F'
          'OPER_NAME'#9'36'#9#1054#1087#1077#1088#1072#1094#1080#1103#9'F')
        IniAttributes.Delimiter = ';;'
        TitleColor = clBtnFace
        FixedCols = 0
        ShowHorzScrollBar = True
